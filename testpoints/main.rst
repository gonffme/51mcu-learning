      ...
      000073 22               [24]  340 	ret
                                    341 ;------------------------------------------------------------
                                    342 ;Allocation info for local variables in function 'longdelay'
                                    343 ;------------------------------------------------------------
                                    344 ;i                         Allocated to registers r7 
                                    345 ;------------------------------------------------------------
                                    346 ;	main.c:11: void longdelay()
                                    347 ;	-----------------------------------------
                                    348 ;	 function longdelay
                                    349 ;	-----------------------------------------
      000074                        350 _longdelay:
                                    351 ;	main.c:14: while(i>0)
      000074 7F 64            [12]  352 	mov	r7,#0x64
      000076                        353 00101$:
      000076 EF               [12]  354 	mov	a,r7
      000077 60 0D            [24]  355 	jz	00104$
                                    356 ;	main.c:16: delay(1000);
      000079 90 03 E8         [24]  357 	mov	dptr,#0x03e8
      ...
      000086 22               [24]  366 	ret
                                    ...
                                    369 ;------------------------------------------------------------
                                    370 ;	main.c:21: void main()
                                    371 ;	-----------------------------------------
                                    372 ;	 function main
                                    373 ;	-----------------------------------------
      000087                        374 _main:
                                    375 ;	main.c:23: while(1)
      000087                        376 00102$:
                                    377 ;	main.c:25: P0=0x33;
      000087 75 80 33         [24]  378 	mov	_P0,#0x33
                                    379 ;	main.c:26: P1=0x33;
      00008A 75 90 33         [24]  380 	mov	_P1,#0x33
                                    381 ;	main.c:27: P2=0x33;
      00008D 75 A0 33         [24]  382 	mov	_P2,#0x33
                                    383 ;	main.c:28: P3=0x33;
      000090 75 B0 33         [24]  384 	mov	_P3,#0x33
                                    385 ;	main.c:29: longdelay();
      000093 12 00 74         [24]  386 	lcall	_longdelay
                                    387 ;	main.c:30: P0=0xcc;
      000096 75 80 CC         [24]  388 	mov	_P0,#0xcc
                                    389 ;	main.c:31: P1=0xcc;
      000099 75 90 CC         [24]  390 	mov	_P1,#0xcc
                                    391 ;	main.c:32: P2=0xcc;
      00009C 75 A0 CC         [24]  392 	mov	_P2,#0xcc
                                    393 ;	main.c:33: P3=0xcc;
      00009F 75 B0 CC         [24]  394 	mov	_P3,#0xcc
                                    395 ;	main.c:34: longdelay();
      0000A2 12 00 74         [24]  396 	lcall	_longdelay
                                    397 ;	main.c:36: }
      0000A5 80 E0            [24]  398 	sjmp	00102$
                                    399 	.area CSEG    (CODE)
                                    400 	.area CONST   (CODE)
                                    401 	.area XINIT   (CODE)
